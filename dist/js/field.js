...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {
    ...
    beforeDestroyEvents: function beforeDestroyEvents() {
      var _this2 = this;

      return this.field.events.map(function (event) {
        return _this2.viaNamespace(event + '.beforeDestroy');
      });
    }
  },
  ...
  methods: {
    ...
    emitBeforeDestroy: function emitBeforeDestroy(field) {
      Nova.$emit(this.viaCurrentNamespace(field.attribute + '.beforeDestroy'), this.field, field);
    },

    emitUpdated: function emitUpdated(field) {
     ...
     */
    chainBeforeDestroy: function chainBeforeDestroy(chain, field) {
      var _this3 = this;
      ...
      var formData = _.tap(new FormData(), function (formData) {
        field.fill(formData);
     ...
     */
    getFields: function () {
      var _ref3 = _asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.mark(function _callee(formData) {
        var _this4 = this;
            ...
            switch (_context.prev = _context.next) {
              case 0:
                ...
                return Nova.request().post('/nova-api/' + this.resourceName + '/chain-fields', formData, {
                  ...
                  _.each(_this4.fields, function (field) {
                    field.fill = function () {
                      return '';
                    };
                  });
      ...
      return _c("form-" + field.component, {
        ...
        on: {
          ...
          "hook:updated": function($event) {
            return _vm.emitUpdated(field)
          },
          "hook:beforeDestroy": function($event) {
            return _vm.emitBeforeDestroy(field)
          }
        }
      })
    }),
